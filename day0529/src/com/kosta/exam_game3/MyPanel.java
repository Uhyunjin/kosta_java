	...
	public void keyPressed(KeyEvent e) {
		switch(e.getKeyCode()) {
			...
			case KeyEvent.VK_RIGHT:
				...
				x += 10;
				break;
			case KeyEvent.VK_UP:System.out.println("위");y-=10;break;
			case KeyEvent.VK_DOWN:System.out.println("아래");y+=10;break;
			case KeyEvent.VK_SPACE:System.out.println("스페이스");break;
		}
		repaint();	//다시 그려주세요 => repaint를 요청하는 것
